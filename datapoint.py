...
HIBP_API_KEY = '012A7CA357541F0AC487871FEEC1891C49C' # Key Not Working
...
def mainMenu():
    print("\n --------------------------------- ")
    print("\n           D҉a҉t҉a҉ ҉P҉o҉i҉n҉t҉              ")
    print("\n --------------------------------- ")
    print("\n                         ----Abdul")
    print(" Select Option ")
    print("\n   1: Decoders ")
    print("   2: Reputation Checker")
    print("   3: DNS Tools")
    print("   4: Hashing")
    print("   5: Phishing Analysis")
    print("   6: URL Scan")
    print("   0: Exit")
    switchMenu(input())
...
# Dig and obtain mailservers by mx records
def mxRecordsInput():
    server = input(' Enter IP\/Domain : ')
    os.system("powershell.exe dig +nostats +short " + server + " mx | sed 's/\.$//g' | cut -d ' ' -f 2")
    phishingMenu()
 
# Parse Website with BeautifulSoup 
def parseWebsiteInput():
    url = input(' Enter URL: ')
...
def hashMenu():
    print("\n --------------------------------- ")
    print(" H A S H I N G   S E C T I O N S ")
    print(" --------------------------------- ")
    print(" What would you like to do? ")
...
def phishingMenu():
    ...
    print(" OPTION 4: Parse a Website")
    print(" OPTION 5: Check MX Records")
    print(" OPTION 0: Exit to Main Menu")
